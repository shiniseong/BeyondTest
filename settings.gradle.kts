...
include(":services:user-service:adapter:inbound:web")
...
include(":services:prescription-service:adapter:inbound:web")
...
include(":services:notification-service:adapter:inbound:web")
